...
from app.api.v1.endpoints import users, config, cq_nhom_lop_hoc_phan, hoc_ky, hinh_thuc_day, hinh_thuc_hoc, he_thong_dm_he_dao_tao, he_thong_nhom_cong_thuc, he_thong_he_so_lop_dong, he_thong_truong_hop_cong_thuc, cq_dashboard, he_thong_phan_quyen_chuc_nang, auth
