...
async def get_danh_sach_nhom_lop_hoc_phan_theo_nam_tai_chinh(
    ...
    """
    columns = await services_cq_nhom_lop.get_danh_sach_nhom_lop_hoc_phan_theo_nam_tai_chinh(db, redis_client, nam_tai_chinh=nam_tai_chinh, trang_thai_loc=trang_thai_loc)
    return columns
