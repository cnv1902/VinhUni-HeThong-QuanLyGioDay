...
class HeThongNhomCongThuc(Base):
    ...
    TuMaHocKy = Column(Integer, nullable=False) # Tạm bỏ ForeignKey("tbl_HocKyHocPhan.MaHocKy")
    DenMaHocKy = Column(Integer, nullable=True) # Tạm bỏ ForeignKey("tbl_HocKyHocPhan.MaHocKy")
